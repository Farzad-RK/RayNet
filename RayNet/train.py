...
PHASE_CONFIG = {
    ...
    2: {
        ...
        'lr': 5e-4,
        'sigma': 1.5,
        'description': 'Introduce gaze gently',
    },
    3: {
        'epochs': (16, 30),
        'lam_lm': 0.5,
        ...
        'lr': 1e-4,
        'sigma': 1.0,
        'description': 'Balanced fine-tuning',
    },
}
...
def train_one_epoch(model, train_loader, optimizer, device, epoch, cfg):
    ...
    for batch in train_loader:
        ...
        # Compute loss with phase-specific weights
...
def train(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # Train
        train_losses = train_one_epoch(model, train_loader, optimizer, device, epoch, cfg)
        ...
        print(f"Epoch {epoch:3d} | Phase {phase} | lr {current_lr:.2e} | "
              ...
              f"ang={train_losses['angular_deg']:.2f}deg | "
