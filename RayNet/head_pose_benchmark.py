"""
    This file contains the benchmarking logic for the 6D prediction
    of headpose estimated by RayNet V4.1 trained on GazeGene dataset.
    Most of the logic is ported from sixdrepnet module (headpose baseline achieved 4 degree MAE):
    Datasets supported:
    - GazeGene
    - AFLW2000-3D
"""
...
from RayNet.raynet import create_raynet, load_pretrained_raynet


def parse_args():
    """Parse input arguments."""
    parser = argparse.ArgumentParser(
        description='Head pose estimation using RayNet V4.1 trained on GazeGene dataset.')
    ...
    # Model configuration
    parser.add_argument('--RayNet_weights', type=str, default='', help='Path to RayNet weights file')
    # --------------------------------------
...
if __name__ == '__main__':
    ...
    model = load_pretrained_raynet(args.RayNet_weights)
