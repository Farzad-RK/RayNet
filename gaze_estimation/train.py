...
def parse_args():
    ...
    parser.add_argument('--ckpt_dir', type=str, default='./ARGaze_checkpoints', help='Directory for periodic checkpoints')
...
def main():
    ...
    for fold, test_sub in enumerate(all_subjects):
        ...
        train_loader = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True, num_workers=4, pin_memory=(device=="cuda"))
        test_loader = DataLoader(test_ds, batch_size=args.batch_size, shuffle=False, num_workers=4, pin_memory=(device=="cuda"))
